...
class _EditBookingPageState extends State<EditBookingPage> {
  ...
  // Controllers
  TextEditingController pointOfOriginController = TextEditingController();
  ...
  TextEditingController bookingNumberController = TextEditingController();
  ...
  TextEditingController notifyAddressController = TextEditingController();
  ...
  TextEditingController tanNumberController = TextEditingController();
  ...
  void initState() {
    ...
    // Controllers
    pointOfOriginController = TextEditingController();
    portOfLoadingController = TextEditingController();
    portOfDischargeController = TextEditingController();
    finalDestinationController = TextEditingController();
    placeOfDeliveryController = TextEditingController();
    customerController = TextEditingController();
    bookingNumberController = TextEditingController();
    shipperController = TextEditingController();
    consigneeController = TextEditingController();
    notifyController = TextEditingController();
    shipperAddressController = TextEditingController();
    consigneeAddressController = TextEditingController();
    notifyAddressController = TextEditingController();

    //New Customer Controllers
    emailIdController = TextEditingController();
    companyController = TextEditingController();
    ledgerController = TextEditingController();
    ledgerGroupController = TextEditingController();
    address1Controller = TextEditingController();
    address2Controller = TextEditingController();
    cityController = TextEditingController();
    panNumberController = TextEditingController();
    tanNumberController = TextEditingController();
  ...
  Future<void> _loadBookingData() async {
    ...
    if(doc.exists){
      setState(() {
      bookingNumberController.text = data['bookingNumber'] ?? '';
      pointOfOriginController.text = data['pointOfOrigin'] ?? '';
      portOfLoadingController.text = data['portOfLoading'] ?? '';
      portOfDischargeController.text = data['portOfDischarge'] ?? '';
      finalDestinationController.text = data['finalDestination'] ?? '';
      placeOfDeliveryController.text = data['placeOfDelivery'] ?? '';
      shipperController.text = data['shipper'] ?? '';
      consigneeController.text = data['consignee'] ?? '';
      notifyController.text = data['notify'] ?? '';
      shipperAddressController.text = data['shipperAddress'] ?? '';
      consigneeAddressController.text = data['consigneeAddress'] ?? '';
      notifyAddressController.text = data['notifyAddress'] ?? '';  
      customerController.text = data['customer'] ?? '';
      _vesselVoyageController.text = data['vesselVoyage'] ?? '';
      finalDestinationController.text = data['finalDestination'] ?? '';
      selectedType = data['type'] ?? 'LCL/LCL';
      selectedStuffingAt = data['stuffingAt'] ?? 'Factory';
      selectedFreightTerms = data['freightTerms'] ?? 'PREPAID';
      freightChargeController.text = data['freightCharge'] ?? '';
      selectedDeliveryType = data['deliveryType'] ?? 'PIER/PIER';
      shipmentDate = DateTime.tryParse((data['shipmentDate']));
      ...
      setState(() {
        ...
        print("Error fetching shipment date: $e"); // Error debug statement
        setState(() {
          isLoading = false;
        });
    }
  ...
  Future<void> _updateBooking() async {
    ...
    Navigator.pop(context); // Go back to the All Bookings page
  }
  ...
  void _showSlotOperatorDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: const Text('New Slot Operator'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextFormField(
